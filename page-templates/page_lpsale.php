...
<main class="lpSale">
    <header class="saleMenu">
        <div class="saleMenu__wrap container">
            ...
            <a href="https://psibufet.pl/serwis" class="btn btn--header dir"><span>Zamów</span></a>
        </div>
        <a href="https://psibufet.pl/serwis" class="salePromobar dir">
            <p></p>
        </a>
    </header>
    <div class="saleMenu--clone"></div>
    <div class="stickyBtn">
        <a href="https://psibufet.pl/serwis" class="btn btn--center dir"><span>Odbierz zniżkę</span></a>
    </div>
        ...
        <div class="saleHeader__wrap">
            ...
            <div class="saleHeader__form">
                ...
                <div class="correct">
                    ...
                    <a href="https://psibufet.pl/serwis" class="btn dir"><span>Stwórz dietę</span></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="saleMiska animateMiska">
        ...
        <div class="saleMiska__cta">
            <a href="https://psibufet.pl/serwis" class="btn dir"><span>Wypróbuj</span></a>
        </div>
    </section>
    ...
    <section class="homeFoodinfo">
        ...
        <a href="https://psibufet.pl/serwis" class="btn btn--center dir dir"><span><?php the_field('front_foodinfo_cta', 5) ?></span></a>
        <div class="foodModal">
    ...
    <section class="saleVideos">
        ...
        <div class="saleVideos__wrap container">
            ...
            <a href="https://psibufet.pl/serwis" class="btn btn--center dir"><span>Dołącz do nich</span></a>
        </div>
    ...
    <section class="saleCompare">
        ...
        <a href="https://psibufet.pl/serwis" class="btn btn--center dir"><span>Stwórz dietę</span></a>
    </section>
