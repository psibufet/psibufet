...
<main class="lpSale">
    ...
    <section class="saleHeader saleHeader--rmkt">
    ...
    <?php $howitworksID = 2310; ?>
    <?php if(get_field('howitworks_step', 5) && get_field('howVideo_video', $howitworksID)): ?>
    <section class="howVideo howVideo--rmkt">
        <div class="howVideo__wrap">
            ...
            <div class="howVideo__content">
                <div class="video video--desktop">
                    <?php
                    $attr = array(
                        'src'       => get_field('howVideo_video', $howitworksID),
                        'poster'    => false,
                    );
                ...
                <div class="video video--mobile">
                    <?php
                    $attr = array(
                        'src'       => get_field('howVideo_video_mobile', $howitworksID),
                        'poster'    => false,
                    );
                    echo wp_video_shortcode($attr); ?>
                </div>
                <div class="content">
                    <h3 class="getMarker getMarker--small"><?php the_field('howVideo_box_title', $howitworksID); ?></h3>
                    <p><?php the_field('howVideo_box_content', $howitworksID); ?></p>
                </div>
            </div>
        </div>
    </section>
    <section class="homeHowitworks homeHowitworks--rmkt">
    ...
    <section class="saleVideos saleVideos--rmkt">
        ...
        <div class="saleVideos__wrap container">
            <div class="saleVideos__main">
                <?php while(have_rows('saleVideos')): the_row();
                    ...
                    $video = get_sub_field('saleVideos_video');
                ?>
            ...
            <div class="saleVideos__list">
                ...
                <div class="saleVideo" data-video="video_0<?php echo get_row_index(); ?>">
                    <div class="saleVideo__thumb">
                        <img src="<?php echo $videoLink['sizes']['large'] ?>"/>
