...
<main class="psibufet psibufet--book">
    ...
    <section class="pbShortcuts">
        ...
        <div class="pbShortcuts__wrap">
            <a href="/jak-to-dziala" class="pbShortcuts__box dir"
                style="background-image: url('<?php echo get_template_directory_uri() . '/images/homepage/homeShortcuts_01.webp'; ?>');">
                <p class="title">Jak to działa?</p>
            </a>
            <a href="/nasze-przepisy" class="pbShortcuts__box dir"
            ...
            <a href="/o-nas" class="pbShortcuts__box dir"
