...
<section class="bookContent book__content container">
    <div class="book__content__header">
        ...
        <p>Jedyna taka psiążka kucharska. <span class="bold">63 przepisy</span> na przepyszne, zdrowe i pełnowartościowe posiłki dla każdego
            psa.</p>
    </div>
    ...
    <div class="bookContent__image">
        <img src="<?php echo get_template_directory_uri() . '/images/book/book_img.png' ?>"/>
        <img class="gratis" src="<?php echo get_template_directory_uri() . '/images/book/gratis_ico.svg' ?>"/>
    </div>
    <a href="#" class="btn freeBook"><span>Odbierz za darmo</span></a>
...
<section class="meetMakers pbShortcuts">
    <div class="meetMakers__wrap">
        <h2 class="getMarker">Poznaj <span class="marker">twórców</span></h2>
        <div class="meetMakers__images">
            <div class="image">
                <img src="<?php echo get_template_directory_uri() . '/images/book/first_person.png'; ?>"/>
            </div>
            <div class="image">
                <img src="<?php echo get_template_directory_uri() . '/images/book/sec_person.png'; ?>"/>
            </div>
            <div class="image">
                <img src="<?php echo get_template_directory_uri() . '/images/book/third_person.png'; ?>"/>
            </div>
        </div>
...
<section class="book__library">
    <div class="container pbShortcuts">
