<?php
/*
 * Template Name: Thank you page - gifts
 */
get_header(); ?>
    ...
    <section class="typMain">
        ...
        <div class="typContent">
            <div class="typContent__solid">
                ...
                <div class="courier courier--referral">
                ...
                <div class="giftInfo">
                    <div class="giftInfo__wrap">
                        <div class="giftInfo__heading">
                            <h2>Czekaj na prezenty</h2>
                            <p>W pierwszej paczce czeka Cię miła niespodzianka w postaci <b>torby z napisem “Kocham pieski”</b>. Dodatkowo dostaniesz też broszurkę, w której znajdują się najważniejsze informacje o PsiBufet.</p>
                        </div>
                        <div class="image">
                            <img src="<?php echo get_template_directory_uri() . '/images/thank-you/gifts.svg'; ?>" />
                        </div>
                    </div>
                </div>
            </div>
