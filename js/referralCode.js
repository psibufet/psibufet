$(document).ready(function(){
	...
	var whitelist = ['', 'jak-to-dziala', 'nasze-przepisy', '?code=' + sPageURL, 'o-nas', 'pracuj-w-psibufet', 'kontakt', 'thank-you', 'regulamin', 'regulamin.pdf', 'gs-wolowe-love', 'gs-jagnie-wcina', 'gs-kurcze-pieczone', 'gs-indyczy-kasek', 'regulamin_dla_hodowcow.pdf'];
